            ...
            with col1:
                ...
                <div style="border: 1px solid #4CAF50; border-radius: 10px; padding: 20px; height: 100%;">
                    ...
                    <ul style="list-style-type: none; padding-left: 10px;">
                        <li style="margin-bottom: 10px;">✅ <b>Transcribe audio & video</b> Meetings and News automatically</li>
            ...
            with col2:
                ...
                <div style="border: 1px solid #2196F3; border-radius: 10px; padding: 20px; background-color: rgba(33, 150, 243, 0.05); height: 100%;">
                    ...
                    <ul style="list-style-type: none; padding-left: 10px;">
                        ...
                        <li style="margin-bottom: 10px;">⭐ <b>Translate summaries to 12+ languages</b> for global teams</li>
